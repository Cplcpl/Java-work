...
public class BaseballStats implements ActionListener
{
	...
	public ActionListener statsButton;
...
////// Action Listeners
	    ...
	    resetButton = new ActionListener()
	    {
	    	public void actionPerformed(ActionEvent e)
	    	{
	    		playField.setText("");
	    ...
	    statsButton = new ActionListener()
	    {
	    	public void actionPerformed(ActionEvent e)
	    	{
	    		String mess = "";
	    		...
	    		for (Player play : players)  
				{
	    			double battingAvg = 0;
	    			int totalHits = 0;
	    			for(int i = 0; i < play.hits.length; i++)
				    {
				    	totalHits += play.hits[i];
				    	battingAvg = (double)totalHits/(double)totalBats;
				    	
				    	
				    }
	    			String result = df.format(battingAvg);
	    			mess += (play.name + ": Batting Avg: " + result + "\n");
				}
...
//////
	    ...
	    show.addActionListener(statsButton);
